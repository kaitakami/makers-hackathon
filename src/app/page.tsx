      ...
      <section className="min-h-screen flex flex-col justify-center">
        <div className="gap-8 items-center pb-16 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 lg:px-6">
          ...
          <div className="mt-4 md:mt-0">
            ...
            <Link href="/#" className={`${buttonVariants({ variant: "outline" })}`}>Join the hackathon</Link>
          </div>
          <Image className="md:block hidden" src="https://images.unsplash.com/photo-1535957998253-26ae1ef29506?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1936&q=80" alt="" width="400" height="700" />
        </div>
      </section>
      {/* TODO: Add footer w/ github link & makers website link */}
    </main>
  )
}
